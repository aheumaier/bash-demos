...
ResultsStorageKeySecretName="$(tr -dc A-Za-z0-9 </dev/urandom | fold -w "${1:-32}" | head -n 1)"
DataStorageKeySecretName="$(cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w 32 | head -n 1)"
DeployStorageSecretName="$(cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w 32 | head -n 1)"
SimEnvPasswordSecretName="$(cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w 32 | head -n 1)"
SimEnvPrivateKeySecretName="$(cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w 32 | head -n 1)"
DevstackPWSecretName="$(cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w 32 | head -n 1)"
DevstackUSERSecretName="$(cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w 32 | head -n 1)"
